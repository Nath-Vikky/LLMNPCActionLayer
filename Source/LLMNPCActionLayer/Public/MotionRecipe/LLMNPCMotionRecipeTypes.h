...
inline constexpr const TCHAR* RegistryVersion = TEXT("llmnpc.motion_primitives.v3");
inline constexpr const TCHAR* CompilerVersion = TEXT("llmnpc.motion_recipe_compiler.v5");
